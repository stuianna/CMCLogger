...
class API_getting_requests(unittest.TestCase):
    ...
    def test_correctly_formed_api_call(self,session_mock):
        ...
        expectedParameters = {
                'start' : self.config.getValue(settings.API_section_name,settings.API_option_start_index),
                'limit' : self.config.getValue(settings.API_section_name,settings.API_option_end_index) - \
                            self.config.getValue(settings.API_section_name,settings.API_option_start_index) + 1,
                'convert' : self.config.getValue(settings.API_section_name,settings.API_option_conversion_currency),
                'sort'  :   'market_cap'
                }
